...
object Constants {
    ...
    const val REOBF_SPIGOT_MOJANG_YARN_MAPPINGS = "$MAPPINGS_DIR/spigot-mojang+yarn-reobf.tiny"
    const val PATCHED_REOBF_SPIGOT_MOJANG_YARN_MAPPINGS = "$MAPPINGS_DIR/spigot-mojang+yarn-reobf-patched.tiny"
