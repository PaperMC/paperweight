...
class SetupHandlerImplV3(
    private val service: UserdevSetup,
    private val bundle: ExtractedBundle<DevBundleV3.Config>,
    private val cache: Path = service.parameters.cache.path,
) : SetupHandler {
    companion object : SetupHandler.Factory<DevBundleV3.Config> {
        override fun create(setupService: UserdevSetup, extractedBundle: ExtractedBundle<DevBundleV3.Config>): SetupHandler =
            SetupHandlerImplV3(setupService, extractedBundle)
    }
