...
class VanillaServerJarDownload(
    @Input
    ...
    override fun execute() {
        ...
        val version = mcManifest.versions.firstOrNull { it.id == minecraftVersion.get() }
        ...
        ioDispatcher("VanillaServerJarDownload").use { dispatcher ->
            runBlocking {
                launch(dispatcher) {
